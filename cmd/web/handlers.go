...
import (
	...
	"github.com/stephanusnugraha/go-stripe/internal/encryption"
...
func (app *application) GetTransactionData(r *http.Request) (TransactionData, error) {
	...
	pi, err := card.RetrievePaymentIntend(paymentIntent)
	if err != nil {
		app.errorLog.Println(err)
		return txnData, err
	}
...
func (app *application) ShowSale(w http.ResponseWriter, r *http.Request) {
	...
	stringMap["result-badge"] = "Refunded"
	stringMap["result-btn"] = "Charge Refunded"
...
func (app *application) ShowSubscription(w http.ResponseWriter, r *http.Request) {
	...
	stringMap["result-badge"] = "Cancelled"
	stringMap["result-btn"] = "Subscription Cancelled"
