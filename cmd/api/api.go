...
import (
	"flag"
	"fmt"
	"github.com/stephanusnugraha/go-stripe/internal/driver"
...
func main() {
	...
	flag.StringVar(&cfg.smtp.username, "smtpuser", "1c9dc13f74a7fb", "smtp user")
	flag.StringVar(&cfg.smtp.password, "smtppass", "691e74f5182459", "smtp password")
