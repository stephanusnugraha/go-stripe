...
func (m *DBModel) GetWidget(id int) (Widget, error) {
	...
	querySql := "SELECT id, name, description, inventory_level, price, coalesce(image, ''), is_recurring, plan_id, created_at, updated_at FROM widgets where id = ?"
...
func (m *DBModel) GetUserByEmail(email string) (User, error) {
	...
	querySQL := `select id, first_name, last_name, email, password, created_at, updated_at from users where email = ?`
...
// UpdateOrderStatus updates the status of order to supply statusID by id
